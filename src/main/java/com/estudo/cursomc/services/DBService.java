...
public class DBService {
	...
	public void intantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null,"Matheus","matheusyyes@gmail.com", "08321183034", TipoCliente.PESSOAFISICA, pe.encode("123"));	
		cli1.getTelefones().addAll(Arrays.asList("41566891","951982457"));	
		
		Cliente cli2 = new Cliente(null,"Ana Costa","luque.chiclete@hotmail.com", "43728492060", TipoCliente.PESSOAFISICA, pe.encode("123"));	
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("4156165","5641564654"));
		...
		Endereco e3 = new Endereco(null, "av Santana", "82", null, "Barueri", "06598-000", cli2, c2);	
